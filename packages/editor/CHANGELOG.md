...
- 2941ff6: Every model rigged from this release on turns differently: the head no longer
...
- fa07593: The head-turn cylinder's radius is an explicit input to the face-warp bake and
...
- bc8156b: The back hair (`hair_back`) now keys its turn bend at the same five stops as the
