...
- 9ac915d: `IdleMotion`'s blink was a 120 ms symmetric triangle — the lid closed and
...
- c45def8: `IkiMotion` runs the three motion drivers as one. Every host so far rebuilt
