...
`detectAlphaBbox` now delegates to the shared scan in `@ikijs/editor-core` instead of re-implementing it, keeping this package's `AutoRigInputError` for an empty layer. Behavior is unchanged.
